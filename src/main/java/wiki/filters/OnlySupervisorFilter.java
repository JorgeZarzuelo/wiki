 ...
 */
@WebFilter("/OnlySupervisorFilter")
public class OnlySupervisorFilter extends HttpFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if (session != null && session.getAttribute("user") != null && session.getAttribute("isSupervisor") != null) {
